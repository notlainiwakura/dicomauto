...
"""
Example test cases demonstrating the use of test data selection fixtures.

These examples show how to:
- Use size-based selection fixtures
- Parametrize tests across modalities
- Handle missing data gracefully with pytest.skip()
- Select subsets of files for batch operations
"""
