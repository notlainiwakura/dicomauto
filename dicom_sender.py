...
"""
DICOM C-STORE client wrapper using pynetdicom.

This is the core of the load generator: we spin up multiple worker threads
and repeatedly send datasets to the Compass listener, recording latency
and errors in PerfMetrics.

We are explicitly targeting C-STORE routing tests (TS_01, TS_02, TS_04).
"""
...
class DicomSender:
    ...
    def _send_single_dataset(
        ...
        """
        Send a single dataset using a fresh association.
        """
    ...
    def load_test_for_duration(
        ...
        """
        Main hot path for TS_04_Load_Stability-style tests.
        """
